...
// string date = 1;
inline void DateRequest::clear_date() {
  date_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& DateRequest::date() const {
  // @@protoc_insertion_point(field_get:DateRequest.date)
  return _internal_date();
}
inline void DateRequest::set_date(const std::string& value) {
  _internal_set_date(value);
  // @@protoc_insertion_point(field_set:DateRequest.date)
}
inline std::string* DateRequest::mutable_date() {
  // @@protoc_insertion_point(field_mutable:DateRequest.date)
  return _internal_mutable_date();
}
inline const std::string& DateRequest::_internal_date() const {
  return date_.GetNoArena();
}
inline void DateRequest::_internal_set_date(const std::string& value) {
  
  date_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void DateRequest::set_date(std::string&& value) {
  
  date_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:DateRequest.date)
}
inline void DateRequest::set_date(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  date_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:DateRequest.date)
}
inline void DateRequest::set_date(const char* value, size_t size) {
  
  date_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:DateRequest.date)
}
inline std::string* DateRequest::_internal_mutable_date() {
  
  return date_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* DateRequest::release_date() {
  // @@protoc_insertion_point(field_release:DateRequest.date)
  
  return date_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void DateRequest::set_allocated_date(std::string* date) {
  if (date != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:DateRequest.date)
}
